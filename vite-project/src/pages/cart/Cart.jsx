...
function Cart() {
 ...
 const buyNow = async () => {
   ...
   var options = {
     key: "rzp_test_gfOlSMrPp2ES8u",
     key_secret: "kjyGge2W7tbrwZzyeWsNprGD",
  ...
  return (
    <Layout >
      <div className="h-screen bg-gray-10 pt-5 mb-[50%]" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
